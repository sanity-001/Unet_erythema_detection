...
if __name__ == "__main__":    
    ...
    #   数据集路径
    #------------------------------#
    dataset_path = "/content/gdrive/MyDrive/unet-keras-master/unet-keras-master/datasets_1"
    ...
    #   权值和主干特征提取网络一定要对应
    #-------------------------------------------#
    model_path = "/content/gdrive/MyDrive/unet-keras-master/unet-keras-master/logs/unet_voc.h5"
